                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="container-fluid">
                            <a class="navbar-brand" href="#">BagShop</a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('auth')}}">Выйти</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="row mt-4 ">
        ...
        <div class="card-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3 class="card-title"><a href="{{route('product',['product' => $product->id])}}">{{$product->title}}</h3>
